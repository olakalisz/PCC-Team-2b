...
'''
    ...
    Modified by Team2b - PCC Hackathon
'''
...
#Pixalatte an image passed as argument
def pixelate(frame):
...
def detectAndTrackMultipleFaces():
    ...
    try:
        while True:
            ...
            #Base image used for training face detection
            ...
            for fid in faceTrackers.keys():
                ...
                roi_color = resultImage[t_y:t_y+t_h, t_x:t_x+t_w]
                face_pixel = pixelate(roi_color)
                resultImage[t_y:t_y+t_h, t_x:t_x+t_w] = face_pixel
